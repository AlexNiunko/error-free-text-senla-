...
-- task_content
insert into public.task_content (id, position, created_at, updated_at, content,is_correct, task_id) values
                                                                                             (1, 1, now(), now(), 'Первая задача: текст для проверки орфографии.',false,1),
